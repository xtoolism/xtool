...
![[Qwen3小模型实测：从4B到30B，到底哪个能用MCP和Obsidian顺畅对话？-根据新尺寸生成图片 _2_-20250430.png]]
...
![[Qwen3-4B-本地模型 + Obsidian-MCP的本地问答-image-20250429.png]]
...
![[Qwen3-4B-本地模型 + Obsidian-MCP的本地问答-image-20250430-4.png|743x747]]
