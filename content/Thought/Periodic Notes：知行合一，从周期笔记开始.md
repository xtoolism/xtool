...
description: Obsidian 的 Periodic Notes 插件，能帮你把年度目标拆解到每一天，结合 PDCA 循环，让计划不再停留在纸上。通过日记、周总结、月总结，能及时复盘和调整方向，逐步实现理想。用好它，真的能让你从`许愿者`变成`掌控者`。
tags: [GTD, 日记]
source: https://mp.weixin.qq.com/s/fh-3geUNhPhoTe-62MtatQ
created: 2025-07-19T12:27:42
updated: 2025-10-02T10:52:00
---
![[file-20251002111853290.png]]
...
但我们常常止步于想法。**那些宏大的目标，像悬在天边的风筝，线却未曾握在手中。** 因为它们需要我们走出舒适区，需要自我挑战。于是，计划往往难以落地。

这篇文章，为你介绍 Obsidian 的一款非常流行 (下载人数近 50 万) 的社区插件 `Periodic Notes`，它最大的价值，是为你提供一个坚实的框架，将经典的 `PDCA` 管理理论融入日常生活，让你摆脱焦虑，赋予你将计划付诸实践的强大能力。
...
插件配置
![[file-20251002111853463.png|765x785]]

命令面板切换
![[image-5.png|685x261]]
最终存储的目录结构是这样的
![[file-20251002111853748.png|163x355]]

### 月/季/年记：P (Plan) - 战略目标的导航仪

月度、季度和年度笔记，正是我们 `PDCA` 循环中的 **P (Plan)** 环节。它们是高屋建瓴的战略规划，负责设定方向和目标。

我们在年初定下年度愿景，在每个月初定下本月要攻克的核心目标。这个计划不求一步到位，但求方向明确。
